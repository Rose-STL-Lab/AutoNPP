...
## Lint using flake8
lint:
	flake8 --max-line-length=120 --ignore=E402,E731,F541,W291,E122,E127,F401,E266,E241,C901,E741,W293,F811,W504,W503,E722 src
...
prefix ?= data
## Download data / model from S3
download:
	@python src/download_data.py --prefix ${prefix}
...
run:
	poetry run python -m pytest -s test/test_autoint_1d_dataset.py
